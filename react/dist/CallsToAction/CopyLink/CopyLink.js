...
var CopyLink = function CopyLink(_ref) {
  var _ref$link = _ref.link,
    ...
    rightIcon = _ref$rightIcon === void 0 ? '' : _ref$rightIcon,
    _ref$successMessage = _ref.successMessage,
    successMessage = _ref$successMessage === void 0 ? 'Link copied!' : _ref$successMessage,
    label = _ref.label;
  var _useState = (0, _react.useState)(false),
    _useState2 = _slicedToArray(_useState, 2),
    showCopymsg = _useState2[0],
    setShowCopyMsg = _useState2[1];
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 8:
            ...
            console.log('Failed to copy link', _context.t0);
          case 11:
          case "end":
