...
var ListItem = function ListItem(_ref) {
  ...
  var _useListContext = (0, _ListContext.useListContext)(),
    hasDivider = _useListContext.hasDivider,
    overwriteItemClass = _useListContext.overwriteItemClass; // Use the custom hook

  return /*#__PURE__*/_react["default"].createElement("div", {
    className: "flex items-center ".concat(hasDivider ? 'py-4' : 'py-2', " ").concat(overwriteItemClass)
